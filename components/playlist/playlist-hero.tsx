...
export const PlaylistHero = ({
	...
	return (
		<div className="h-[30vh] max-h-[400px] min-height-[340px] p-4 lg:p-[1.125rem_1.5rem]">
			<div className="flex gap-4">
				...
				<div className="flex flex-col justify-end">
					...
					<div className="mt-2">
						<h1 className="text-baseText text-3xl xl:text-5xl 2xl:text-7xl font-bold line-clamp-3 mt-[0.08em] mb-[0.12em]">
							{name}
						</h1>
					</div>
