...
type TrackComponentProps = { data: TrackWithIndex; playlistUri: string };

export const Track = ({ data, playlistUri }: TrackComponentProps) => {
	...
	return (
		...
		>
			<div className="relative">
				...
				>
					{!isHovered && !isActivelyPlaying && index + 1}
					{!isHovered && isActivelyPlaying && (
						<Image
							alt="grid cell icon"
